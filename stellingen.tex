...
\begin{examenvraag}
	...
	\begin{stelling-antwoord}{Waar}
    	\todo[inline]{ben niet volledig zeker}
    	Hij zegt dat het niet mogelijk is om harmonie te vinden tussen beiden omdat het altijd tot conflict leidt. (procrustesbed)
  	\end{stelling-antwoord}
