...
\begin{examenvraag}
    ...
    \begin{antwoord}
        Er heerst een toenemende onzekerheid door het oneindige aanbod aan 
        keuzes.‭ ‬Kunnen kiezen brengt met zich mee dat men moet kiezen,‭ ‬men 
        wordt letterlijk moe van al dat kiezen.‭ ‬Bovendien hebben we het 
        moeilijker om onszelf te plaatsen in een groter en overkoepelend 
        geheel omwille van oriëntatieverlies.‭ ‬Zingeving en‭ ‬–vinding worden 
